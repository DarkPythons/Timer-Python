"""
Содержит функции для создания диаграммы, подготовки/валидации данных и тд.
create_pandas_object - создание фрейма данных pandas на основании данных
validate_timers_seconds - проверка количества секунд на всех таймерах (связано
с ошибкой plt, она не может делать вывод даиграммы на основании данных, где все 0)
create_diagram_object - создание объекта самой диаграммы
validate_user_path_diag - валидация пути, куда пользователь хочет загрузить свою диаграмму
get_file_path_diagram - получение пути от пользователя, куда сохранить диграмму
"""
