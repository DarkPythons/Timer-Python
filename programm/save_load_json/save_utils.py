...
def create_data_to_json(all_timers_dict: dict[str, Timer]) -> dict[str, dict[str, int|str]]:
    """
...
def save_dict_data_json(dict_data_to_json: dict[str, dict[str, int|str]], json_path: str) -> bool:
    """
    Сохраняет словарь из create_data_to_json в файл json по определенному пути.
    dict_data_to_json - словарь, который нужно сохранить в json файл
